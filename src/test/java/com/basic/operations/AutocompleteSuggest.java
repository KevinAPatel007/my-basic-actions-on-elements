...
public class AutocompleteSuggest {
    ...
    public void testAutocomplete() throws Exception {
        ...
        WebElement text = driver.findElement(By.xpath("//*[@id=\"LandingAirBookingSearchForm_originationAirportCode\"]"));
        text.sendKeys(partialText);

        WebElement element = driver.findElement(By.id("Depart"));
        List<WebElement> results = element.findElements(By.tagName("LGA"));
